...
namespace yogi
{
	...
	void PhysicsSystem::SetCollisionBox(b2Body* body, const CollisionData& data, class GameObject* gameObject)
	{
		...
		fixtureDef.userData.pointer = reinterpret_cast<uintptr_t>(gameObject);

		body->CreateFixture(&fixtureDef);
	}

	void PhysicsSystem::SetCollisionBoxStatic(b2Body* body, const CollisionData& data, GameObject* gameObject)
	{
